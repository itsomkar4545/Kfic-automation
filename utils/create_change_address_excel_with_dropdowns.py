...
area_options = ['ABDULLA AL-SALEM', 'SALMIYA', 'JABRIYA', 'HAWALLI', 'KHALDIYA', 'AHMADI', 'FAHAHEEL', 'MANGAF']
...
lists_sheet.write_column('D1', area_options)
lists_sheet.write_column('E1', district_options)
...
workbook.define_name('AreaList', '=Lists!$D$1:$D$8')
workbook.define_name('DistrictList', '=Lists!$E$1:$E$6')
...
worksheet.set_column('E:E', 20)  # Area
worksheet.set_column('F:F', 15)  # District
worksheet.set_column('G:L', 12)  # Block to Floor

# Write headers in row 1
headers = ['Action', 'Customer Type', 'Status', 'Living Since', 'Area', 'District', 'Block', 'Street', 'Building', 'Unit Type', 'Unit No', 'Floor']
...
worksheet.data_validation('E3', {'validate': 'list', 'source': '=AreaList'})
worksheet.data_validation('F3', {'validate': 'list', 'source': '=DistrictList'})
...
worksheet.write('E3', 'SALMIYA', data_format)
worksheet.write('F3', 'HAWALLI', data_format)
...
worksheet.data_validation('E7', {'validate': 'list', 'source': '=AreaList'})
worksheet.data_validation('F7', {'validate': 'list', 'source': '=DistrictList'})
...
worksheet.write('E7', 'JABRIYA', data_format)
worksheet.write('F7', 'HAWALLI', data_format)
...
worksheet.data_validation('E11', {'validate': 'list', 'source': '=AreaList'})
worksheet.data_validation('F11', {'validate': 'list', 'source': '=DistrictList'})
...
print("- Area: ABDULLA AL-SALEM, SALMIYA, JABRIYA, HAWALLI, KHALDIYA, AHMADI, FAHAHEEL, MANGAF")
